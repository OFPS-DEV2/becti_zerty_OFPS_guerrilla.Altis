with missionNamespace do {
	...
	GUER_SOLDIER_AA = "I_G_Soldier_F"; //replace AA with ar, resistance shouldn't have aa launchers
	GUER_SOLDIER_AR = "I_G_Soldier_AR_F";
	GUER_SOLDIER_AT = "I_G_Soldier_F"; //replaced lat with MG
	...
	GUER_SOLDIER_PILOT = "I_G_Soldier_F";
	GUER_SOLDIER_SQUADLEADER = "I_G_Soldier_SL_F";
	GUER_SOLDIER_SNIPER = "I_G_Soldier_F";
	...
	GUER_SOLDIERS_SPECOPS = ["I_G_Soldier_F"];
	GUER_SOLDIERS_ENGINEER = [GUER_SOLDIER_ENGINEER, "I_G_engineer_F"];
	GUER_SOLDIERS_SNIPERS = [GUER_SOLDIER_SNIPER, "I_G_Soldier_F", "I_G_Soldier_F"];

	//--- Vehicles
	// GUER_VEHICLE_AA = ["aa1","aa2"];
	GUER_VEHICLE_APC = ["I_G_Offroad_01_armed_F"]; //todo: replace with real veh later on
	...
	GUER_VEHICLE_ARMORED_HEAVY = ["I_G_Offroad_01_armed_F"];
	GUER_VEHICLE_ARMORED_LIGHT = ["I_G_Offroad_01_armed_F"];   
	// GUER_VEHICLE_MECHANIZED = ["mechanized1","mechanized2"];
	GUER_VEHICLE_MOTORIZED = ["I_G_Offroad_01_armed_F", "I_G_Offroad_01_armed_F", "I_G_Offroad_01_armed_F"];
